...
#  Default: 'alejandrogiacometti'
# c.Session.username = 'alejandrogiacometti'
...
def script_post_save(model, os_path, contents_manager, **kwargs):
    ...
    print(model, os_path, contents_manager, kwargs)
...
#  Choices: any of ['sha384', 'blake2b', 'blake2s', 'sha1', 'sha3_224', 'sha3_256', 'sha3_512', 'sha224', 'md5', 'sha256', 'sha3_384', 'sha512']
#  Default: 'sha256'
